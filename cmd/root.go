...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.pascollector.yaml)")
...
func initConfig() {
	...
	if err := viper.ReadInConfig(); err == nil {
		...
		Config.Port = DefaultPort // default value
